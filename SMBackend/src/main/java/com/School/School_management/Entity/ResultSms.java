...
public class ResultSms {
    ...
    @Column(name = "sms_body", nullable = false, columnDefinition = "TEXT")
    ...
    public static class Builder {
        ...
        public ResultSms build() {
            ResultSms entity = new ResultSms();
            entity.setId(id);

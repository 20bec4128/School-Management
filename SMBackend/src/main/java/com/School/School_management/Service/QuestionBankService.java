...
public interface QuestionBankService {
    Map<String, Object> getQuestionBanksPage(Long headOfficeId, Long schoolId, Long classId, Long subjectId, String questionType, String questionLevel, String status, int page, int size, String search);

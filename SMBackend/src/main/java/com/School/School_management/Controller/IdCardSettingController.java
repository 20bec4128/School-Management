...
public class IdCardSettingController {
    ...
    public IdCardSettingController(IdCardSettingService idCardSettingService) {
        this.idCardSettingService = idCardSettingService;
    }
    ...
    public Page<IdCardSettingDto> list(
        ...
        return idCardSettingService.list(headOfficeId, schoolId, search, page, size, CurrentUserHolder.get());
    }

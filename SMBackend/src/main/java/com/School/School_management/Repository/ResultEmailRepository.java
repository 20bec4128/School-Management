...
@Repository
public interface ResultEmailRepository extends JpaRepository<ResultEmail, Long> {

    @Query("SELECT r FROM ResultEmail r WHERE " +
    ...
    List<ResultEmail> findByScope(@Param("headOfficeId") Long headOfficeId, 
    ...
    Page<ResultEmail> findByScopeWithSearch(@Param("headOfficeId") Long headOfficeId, 
                                            @Param("schoolId") Long schoolId, 

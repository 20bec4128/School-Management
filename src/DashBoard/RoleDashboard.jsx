...
const studentIcon = '/assets/images/icons/student-icon.png'
const teacherIcon = '/assets/images/icons/teacher-icon.png'
const guardianIcon = '/assets/images/icons/guardian-icon.png'
const feesIcon = '/assets/images/icons/fees-icon1.png'
const attendanceIcon = '/assets/images/icons/attendence-icon1.png'
const libraryIcon = '/assets/images/icons/library-icon.png'
const studentBg = '/assets/images/bg/edit-profile-bg.png'
const studentAvatar = '/assets/images/thumbs/studnt-edit-profile-img.png'
const widgetOne = '/assets/images/icons/teacher-widget-icon1.png'
const widgetTwo = '/assets/images/icons/teacher-widget-icon2.png'
const widgetThree = '/assets/images/icons/teacher-widget-icon3.png'
const courseOne = '/assets/images/icons/dashboard-icon1.png'
const courseTwo = '/assets/images/icons/dashboard-icon2.png'
const courseThree = '/assets/images/icons/dashboard-icon3.png'
const lmsIconOne = '/assets/images/icons/lms-icon-1.png'
const lmsIconTwo = '/assets/images/icons/lms-icon-2.png'
const lmsIconThree = '/assets/images/icons/lms-icon-3.png'
const lmsIconFour = '/assets/images/icons/lms-icon-4.png'
const lmsBgOne = '/assets/images/icons/lms-card-gradient-bg1.png'
const lmsBgTwo = '/assets/images/icons/lms-card-gradient-bg2.png'
const lmsBgThree = '/assets/images/icons/lms-card-gradient-bg3.png'
const lmsBgFour = '/assets/images/icons/lms-card-gradient-bg4.png'
const sessionOne = '/assets/images/thumbs/session-img1.png'
const sessionTwo = '/assets/images/thumbs/session-img2.png'

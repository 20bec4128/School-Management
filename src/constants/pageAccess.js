...
export const PAGE_KEY_PERMISSIONS = {
  ...
  subject: ['SUBJECT_MANAGE', 'SUBJECT_MANAGE_ASSIGNED', '*'],
  syllabus: ['SYLLABUS_MANAGE', 'SYLLABUS_MANAGE_ASSIGNED', '*'],
  'study-material': ['STUDY_MATERIAL_MANAGE', 'STUDY_MATERIAL_MANAGE_ASSIGNED', '*'],
  'live-class': ['LIVE_CLASS_JOIN', 'LIVE_CLASS_MANAGE', 'LIVE_CLASS_MANAGE_ASSIGNED', '*'],
  assignment: ['ASSIGNMENT_SUBMIT', 'ASSIGNMENT_MANAGE', 'ASSIGNMENT_MANAGE_ASSIGNED', '*'],
  submission: [
    'ASSIGNMENT_SUBMIT',
    'SUBMISSION_MANAGE',
  ...
  // Lesson plan module
  lesson: ['LESSON_MANAGE', 'LESSON_MANAGE_ASSIGNED', '*'],
  topic: ['TOPIC_MANAGE', 'TOPIC_MANAGE_ASSIGNED', '*'],
  'lesson-timeline': ['LESSON_PLAN_MANAGE', 'LESSON_PLAN_MANAGE_ASSIGNED', '*'],
  'lesson-status': ['LESSON_PLAN_MANAGE', 'LESSON_PLAN_MANAGE_ASSIGNED', '*'],
  'lesson-plan': ['LESSON_PLAN_MANAGE', 'LESSON_PLAN_MANAGE_ASSIGNED', '*'],
  ...
  'leave-type': ['ADMIN_USER_MANAGE', '*'],
  'leave-application': ['ADMIN_USER_MANAGE', '*'],
  'waiting-application': ['ADMIN_USER_MANAGE', '*'],
  'approved-application': ['ADMIN_USER_MANAGE', '*'],
  'declined-application': ['ADMIN_USER_MANAGE', '*'],

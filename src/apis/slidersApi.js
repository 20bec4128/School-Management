...
export const fetchSlidersPage = async ({ headOfficeId, schoolId, status, search = '', page = 0, size = 10 } = {}) => {
...
export const fetchSliders = async ({ headOfficeId, schoolId } = {}) => {

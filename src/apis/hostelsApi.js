...
export const fetchHostels = async ({ headOfficeId, schoolId } = {}) => {
...
export const fetchHostelsPage = async ({ headOfficeId, schoolId, search = '', page = 0, size = 10 } = {}) => {
  const qs = new URLSearchParams({

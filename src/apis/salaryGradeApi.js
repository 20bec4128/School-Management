...
export const createSalaryGrade = async (payload) => {
...
export const updateSalaryGrade = async (id, payload) => {
...
export const deleteSalaryGrade = async (id) => {

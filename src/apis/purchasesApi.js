...
export const fetchPurchasesPage = async ({
  ...
  if (supplierId != null && String(supplierId).trim() !== '') qs.set('supplierId', String(supplierId))
  if (categoryId != null && String(categoryId).trim() !== '') qs.set('categoryId', String(categoryId))
  if (productId != null && String(productId).trim() !== '') qs.set('productId', String(productId))

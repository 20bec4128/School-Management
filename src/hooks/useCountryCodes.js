...
const useCountryCodes = () => {
  ...
  const getByIso = (iso) => COUNTRY_CODES.find((c) => c.iso === iso) || null

  const getByCode = (code) => COUNTRY_CODES.find((c) => c.code === code) || null

  return { countries: COUNTRY_CODES, search, getByIso, getByCode }
}

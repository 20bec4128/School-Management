    ...
    <div className="dashboard-main-body">
      <div className="breadcrumb d-flex flex-wrap align-items-center justify-content-between gap-3 mb-24">
        ...
        <button
          ...
          onClick={() =>
            onNavigate
              ? onNavigate("transport-route-create")
              : (window.location.href = "/transport-route-create")
          }
        >
                ...
                {paginatedData.length === 0 ? (
                  ...
                  paginatedData.map((row, idx) => (
                    <tr key={idx}>
                      ...
                      {visibleColumns.routeStart && <td>{row.routeStart}</td>}
                      {visibleColumns.routeEnd && <td>{row.routeEnd}</td>}
                      {visibleColumns.vehicle && <td>{row.vehicle}</td>}
                      {visibleColumns.stopCount && (
                        <td>{row.stops?.length || 0}</td>
                      )}
                      <td>

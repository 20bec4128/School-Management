...
const EmployeeAttendanceReport = () => {
  ...
  const filtered = useMemo(() => {
    ...
    return data.filter((row) => {
      ...
      const matchesDept = filters.department === 'Select' || row.department === filters.department;
  ...
  return (
    <div className="dashboard-main-body">
      <div className="breadcrumb d-flex flex-wrap align-items-center justify-content-between gap-3 mb-24">
        <div>
          <h1 className="fw-semibold mb-4 h6 text-primary-light">Employee Attendance Report</h1>
          <span className="text-secondary-light">Dashboard / Employee Attendance</span>
        </div>
      </div>
        ...
        <div className="card-body p-0 dataTable-wrapper">
          <div className="d-flex align-items-center justify-content-between flex-wrap gap-16 px-20 py-12 border-bottom border-neutral-200">
            <div className="d-flex flex-wrap align-items-center gap-16">
              ...
              <div className="dropdown">
                ...
                <ul className="dropdown-menu p-12 border bg-base shadow">
                  <li><button type="button" className="dropdown-item px-16 py-8 rounded text-secondary-light bg-hover-neutral-200 d-flex align-items-center gap-10"><i className="ri-file-text-line"></i> CSV</button></li>
                  <li><button type="button" className="dropdown-item px-16 py-8 rounded text-secondary-light bg-hover-neutral-200 d-flex align-items-center gap-10"><i className="ri-file-excel-2-line"></i> Excel</button></li>
                  <li><button type="button" className="dropdown-item px-16 py-8 rounded text-secondary-light bg-hover-neutral-200 d-flex align-items-center gap-10"><i className="ri-file-3-line"></i> PDF</button></li>
                </ul>
              </div>
            ...
            <div className="position-relative">
              <input type="text" className="form-control ps-40 py-9 border border-neutral-300 radius-8 text-secondary-light" placeholder="Search employee..." value={search} onChange={(e) => setSearch(e.target.value)} />
          ...
          <div className="p-0 table-responsive">
            <table className="table bordered-table mb-0 data-table employee-attendance-table" style={{ minWidth: 1500 }}>
              <thead>
                <tr>
                  ...
                  <th scope="col" style={{ position: 'sticky', left: '70px', background: '#fff', zIndex: 2, minWidth: '200px' }}>Employee Name</th>
                  {dateColumns.map((col) => (
              ...
              <tbody>
                {paginated.length === 0 ? (
                  <tr>
                    <td colSpan={33} className="text-center py-40 text-secondary-light">No records found.</td>
                  </tr>
                ) : (
      ...
      <SlideSidebar isOpen={isFilterSidebarOpen} title="Filter Attendance" onClose={() => setIsFilterSidebarOpen(false)}>
        <form className="p-20 d-grid gap-16" onSubmit={handleApplyFilters}>
          ...
          <div>
            <label className="text-sm fw-semibold text-primary-light d-inline-block mb-8">Department</label>

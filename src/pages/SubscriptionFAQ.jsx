...
const SubscriptionFAQ = () => {
  ...
  const handleExportExcel = () => {
    ...
    XLSX.utils.book_append_sheet(wb, ws, "SubscriptionFAQs");
    XLSX.writeFile(wb, "Subscription_FAQ_List.xlsx");
  };
  ...
  return (
    <div className="dashboard-main-body">
      <div className="breadcrumb d-flex flex-wrap align-items-center justify-content-between gap-3 mb-24">
        <div>
          <h1 className="fw-semibold mb-4 h6 text-primary-light">Subscription FAQ</h1>
          <span className="text-secondary-light">Subscription / FAQ Management</span>
        </div>
      ...
      >
        <div className="avm-grid">
          <FormField label="Title" required full>
            <input type="text" className="avm-input" id="title" placeholder="Enter FAQ title" value={formData.title} onChange={handleInputChange} />
          </FormField>

          <FormField label="Description" required full>
            <textarea rows={6} className="avm-input avm-textarea" id="description" placeholder="Enter FAQ description" value={formData.description} onChange={handleInputChange} style={{ paddingLeft: '2.5rem' }} />
          </FormField>
        </div>
      </WizardPopup>

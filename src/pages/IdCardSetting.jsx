...
const IdCardSetting = () => {
  ...
  const schoolOptions = useMemo(
    () => Array.from(new Set(idCardSettings.map((r) => r.school))),
    [],
  )

  const filtered = useMemo(() => {
    const q = search.trim().toLowerCase()
    return idCardSettings.filter((r) => {
      const matchesSearch =
        !q ||
  ...
  const openEdit = (row) => {
    setEditForm({
      ...
      schoolNameFontSize: '',
      schoolNameColor: '#333333',
      schoolAddress: '',
      schoolAddressColor: '#333333',
      idNoFontSize: '',
      idNoColor: row.borderColor,
      idNoBackground: row.borderColor,
      titleFontSize: '',
      ...
      <div className="avm-grid">
        {step === 0 ? (
          <>
            ...
            <ColorField label="Border Color" id="borderColor" value={form.borderColor} onChange={handleChange(setter)} />
            <ColorField label="Top Background" id="topBackground" value={form.topBackground} onChange={handleChange(setter)} />

            <FormField label="Card School Name" full>
              <input type="text" className="avm-input" id="cardSchoolName" placeholder="Card School Name" value={form.cardSchoolName} onChange={handleChange(setter)} />
            </FormField>

            <FormField label="School Name Font Size">
              <input type="number" className="avm-input" id="schoolNameFontSize" placeholder="e.g. 14" value={form.schoolNameFontSize} onChange={handleChange(setter)} />
            </FormField>

            <ColorField label="School Name Color" id="schoolNameColor" value={form.schoolNameColor} onChange={handleChange(setter)} />
          </>
        ) : null}
        ...
        {step === 1 ? (
          <>
            <FormField label="School Address" full>
              <input type="text" className="avm-input" id="schoolAddress" placeholder="School Address" value={form.schoolAddress} onChange={handleChange(setter)} />
            </FormField>

            <ColorField label="School Address Color" id="schoolAddressColor" value={form.schoolAddressColor} onChange={handleChange(setter)} />

            <FormField label="ID No Font Size">
              <input type="number" className="avm-input" id="idNoFontSize" placeholder="e.g. 12" value={form.idNoFontSize} onChange={handleChange(setter)} />
            </FormField>

            <ColorField label="ID No Color" id="idNoColor" value={form.idNoColor} onChange={handleChange(setter)} />
            <ColorField label="ID No Background" id="idNoBackground" value={form.idNoBackground} onChange={handleChange(setter)} />

            <FormField label="Title Font Size">
              <input type="number" className="avm-input" id="titleFontSize" placeholder="e.g. 13" value={form.titleFontSize} onChange={handleChange(setter)} />
            </FormField>

            <ColorField label="Title Color" id="titleColor" value={form.titleColor} onChange={handleChange(setter)} />

            <FormField label="Value Font Size">
              <input type="number" className="avm-input" id="valueFontSize" placeholder="e.g. 13" value={form.valueFontSize} onChange={handleChange(setter)} />
            </FormField>

            <ColorField label="Value Color" id="valueColor" value={form.valueColor} onChange={handleChange(setter)} />
          </>
        ) : null}
        ...
        {step === 2 ? (
          <>
            <FormField label="Bottom Signature" required full>
              <input type="text" className="avm-input" id="bottomSignature" placeholder="Bottom Signature" value={form.bottomSignature} onChange={handleChange(setter)} />
            </FormField>

            <ColorField label="Signature Background" id="signatureBackground" value={form.signatureBackground} onChange={handleChange(setter)} />
            <ColorField label="Signature Color" id="signatureColor" value={form.signatureColor} onChange={handleChange(setter)} />

            <FormField label="Signature Align" noIcon>
              <select className="avm-select" id="signatureAlign" value={form.signatureAlign} onChange={handleChange(setter)}>

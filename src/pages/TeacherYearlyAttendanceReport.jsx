...
const TeacherYearlyAttendanceReport = () => {
  ...
  return (
    <div className="dashboard-main-body">
      <div className="breadcrumb d-flex flex-wrap align-items-center justify-content-between gap-3 mb-24">
        <div>
          <h1 className="fw-semibold mb-4 h6 text-primary-light">Teacher Yearly Attendance Report</h1>
          <span className="text-secondary-light">Dashboard / Teacher Yearly Attendance</span>
        </div>
      </div>
          ...
          <div className="p-0 table-responsive">
            <table className="table bordered-table mb-0 data-table" style={{ minWidth: 1200 }}>
              <thead>
                <tr>
                  ...
                  {columnOptions.map((col) => visibleColumns[col.key] && (
                    <th scope="col" key={col.key} className={col.key === 'teacherName' ? '' : 'text-center'}>
                      {col.label}
                    </th>
                  ))}
                </tr>
              ...
              <tbody>
                {paginated.length === 0 ? (
                  <tr>
                    <td colSpan={visibleColumnCount + 1} className="text-center py-40 text-secondary-light">No teacher records found.</td>
                  </tr>
                ) : (
                  paginated.map((row, idx) => (
                    <tr key={idx}>
                      ...
                      {columnOptions.map((col) => visibleColumns[col.key] && (
                        <td key={col.key} className={col.key === 'teacherName' ? 'fw-medium text-primary-light' : 'text-center'}>
...
export default TeacherYearlyAttendanceReport
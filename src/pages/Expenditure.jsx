...
const Expenditure = () => {
  ...
  const filtered = useMemo(() => {
    ...
    return data.filter((row) => {
      ...
      const matchesMethod = filters.expenditureMethod === 'Select' || row.expenditureMethod === filters.expenditureMethod
    ...
    <div className="dashboard-main-body">
      <div className="breadcrumb d-flex flex-wrap align-items-center justify-content-between gap-3 mb-24">
        <div>
          ...
          <span className="text-secondary-light">Dashboard / Expenditure</span>
        </div>
        <button
        ...
        >
          <i className="ri-add-line"></i> Add Expenditure
        </button>
      </div>
      ...
      >
        <div className="avm-grid">
          ...
          <FormField label="Expenditure Head" required>
            <select className="avm-select" id="expenditureHead" value={addForm.expenditureHead} onChange={handleInputChange}>
              <option value="">--Select--</option>
            </select>
          </FormField>

          <FormField label="Expenditure Method" required>
            <select className="avm-select" id="expenditureMethod" value={addForm.expenditureMethod} onChange={handleInputChange}>
              <option value="">--Select--</option>
            </select>
          </FormField>
        ...
        <form className="p-20 d-grid gap-16" onSubmit={handleApplyFilters}>
          ...
          <div>
            ...
            <select
              ...
              onChange={(e) => setPendingFilters((p) => ({ ...p, expenditureMethod: e.target.value }))}
            >

...
const columnOptions = [
  ...
  { key: 'numericName', label: 'Numeric Name' },
      ...
      <div className="breadcrumb d-flex flex-wrap align-items-center justify-content-between gap-3 mb-24">
        <div>
          ...
          <div>
            ...
            <span className="text-secondary-light"> / Class</span>
          </div>
        </div>
        <button
          type="button"
            ...
            <table className="table bordered-table mb-0 data-table" style={{ minWidth: 700 }}>
              <thead>
                <tr>
                  ...
                  {visibleColumns.numericName ? <th scope="col">Numeric Name</th> : null}
                ...
                {paginated.length === 0 ? (
                  ...
                  paginated.map((row) => (
                    <tr key={row.sl}>
                      ...
                      {visibleColumns.numericName ? (
                        <td>
                          <span
                            className="bg-primary-100 text-primary-600 px-12 py-4 radius-4 fw-medium text-sm"
                          >
                            {row.numericName}
                          </span>
                        </td>

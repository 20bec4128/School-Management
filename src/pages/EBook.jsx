...
const EBook = ({ onNavigate }) => {
  ...
  const handleExportExcel = () => {
    ...
    XLSX.utils.book_append_sheet(workbook, worksheet, "EBooks");
    XLSX.writeFile(workbook, "EBook_Library_List.xlsx");
  };
                    ...
                    <tr key={idx}>
                            ...
                            <td key={col.key}>
                              {col.key === "coverImage" ? (
                                <img
                                  ...
                                  alt="cover"
                                  className="w-40-px h-50-px radius-4"
                                />
                              ) : col.key === "ebookName" ? (
                      ...
                      <td>
                        <div className="d-flex align-items-center gap-10">
                          <button className="bg-info-focus text-info-600 w-32-px h-32-px d-flex align-items-center justify-content-center rounded-circle border-0">
                            <i className="ri-download-2-line"></i>
                          </button>
                          <button className="bg-danger-focus text-danger-600 w-32-px h-32-px d-flex align-items-center justify-content-center rounded-circle border-0">

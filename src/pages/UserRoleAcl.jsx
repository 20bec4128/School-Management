...
const GROUP_MATCHERS = {
  ...
  'academic-management': (code) =>
    /^(CLASS_MANAGE|SECTION_MANAGE|SUBJECT_MANAGE|SUBJECT_VIEW_OWN|SUBJECT_VIEW_CHILD|SUBJECT_VIEW_ASSIGNED|SYLLABUS_MANAGE|SYLLABUS_VIEW_OWN|SYLLABUS_VIEW_CHILD|STUDY_MATERIAL_MANAGE|STUDY_MATERIAL_VIEW_OWN|STUDY_MATERIAL_VIEW_CHILD|LIVE_CLASS_MANAGE|LIVE_CLASS_VIEW_OWN|LIVE_CLASS_VIEW_CHILD|LIVE_CLASS_JOIN|ASSIGNMENT_MANAGE|ASSIGNMENT_VIEW_OWN|ASSIGNMENT_VIEW_CHILD|ASSIGNMENT_SUBMIT|SUBMISSION_MANAGE|SUBMISSION_VIEW_OWN|SUBMISSION_VIEW_CHILD|SUBMISSION_VIEW_ASSIGNED)$/.test(code),

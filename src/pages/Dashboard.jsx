                                  ...
                                  <div className="w-100">
                                    ...
                                    */}
                                    <BarChart
                                      labels={labels}
                                      series={[
                                        { name: 'Total Fee', color: '#25A194', data: [25, 35, 50, 60, 26, 20, 40, 20, 50, 16, 10, 40] },
                                        { name: 'Collected Fee', color: '#FF7A2C', data: [15, 16, 22, 28, 14, 15, 20, 10, 25, 10, 6, 20] },
                                      ]}
                                      height={260}
                                      stacked
                                      showValueLabels
              ...
              <div className="card h-100">
                ...
                <div className="card-body p-0">
                  ...
                  <div
                    ...
                    <div className="d-flex align-items-center gap-10">
                      <span className="w-32-px h-32-px bg-primary-50 rounded-circle d-flex justify-content-center align-items-center flex-shrink-0">
                        <img src="/assets/images/icons/sheild-icon.png" alt="Overview" className="w-20-px h-20-px" />
                      </span>
                  ...
                  <div className="p-20">
                    ...
                    <div className="w-100">
                      ...
                      <StepAreaChart
                        ...
                        series={[
                          { name: 'Income', color: '#25A194', fill: '#25A194', data: [48, 35, 55, 32, 48, 30, 14, 50, 56] },
                          { name: 'Expense', color: '#FF7A2C', fill: '#FF7A2C', data: [10, 20, 12, 25, 22, 60, 40, 32, 24] },
                        ]}
                        height={260}
                        maxValue={70}
                        tooltip
              ...
              <div className="card h-100">
                ...
                <div className="card-body p-0">
                  ...
                  <div
                    ...
                    <div className="d-flex align-items-center gap-10">
                      <span className="w-32-px h-32-px bg-primary-50 rounded-circle d-flex justify-content-center align-items-center flex-shrink-0">
                        <img src="/assets/images/icons/student-icon.png" alt="New Admissions" className="w-20-px h-20-px" />
                      </span>

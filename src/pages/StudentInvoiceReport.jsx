...
const StudentInvoiceReport = () => {
  ...
  const renderCell = (row, column) => {
    ...
    // Formatting for Currency/Amounts
    if (['netAmount', 'paidAmount', 'balance'].includes(column.key)) {
      return <span className="fw-medium text-secondary-light">{value != null ? value : '0.00'}</span>;
    }
  ...
  return (
    <div className="dashboard-main-body">
        ...
        <div className="card-body p-0 dataTable-wrapper">
          <div className="d-flex align-items-center justify-content-between flex-wrap gap-16 px-20 py-12 border-bottom border-neutral-200">
            ...
            <div className="position-relative">
              <input type="text" className="form-control ps-40 py-9 border border-neutral-300 radius-8 text-secondary-light" placeholder="Search invoices..." value={search} onChange={(e) => setSearch(e.target.value)} />
          ...
          <div className="p-0 table-responsive">
            <table className="table bordered-table mb-0 data-table">
              ...
              <tbody>
                {paginated.length === 0 ? (
                  <tr>
                    <td colSpan={visibleColumnCount + 1} className="text-center py-40 text-secondary-light">No invoices found.</td>
                  </tr>
                ) : (
      ...
      <SlideSidebar isOpen={isFilterSidebarOpen} title="Filter Student Invoice" onClose={() => setIsFilterSidebarOpen(false)}>

...
const FIELD_ICONS = {
  ...
  'Email': 'ri-mail-line',
  'Phone': 'ri-phone-line',
  'Contact Name': 'ri-user-follow-line',
  ...
  return (
    <div className="dashboard-main-body">
      <div className="breadcrumb d-flex flex-wrap align-items-center justify-content-between gap-3 mb-24">
        ...
        <button className="btn btn-primary-600 d-flex align-items-center gap-6" onClick={() => onNavigate?.('add-asset-vendor')}>
          <i className="ri-add-large-line"></i> Add Vendor
        </button>
      </div>
        ...
        <div className="card-body p-0 dataTable-wrapper">
          ...
          <div className="d-flex align-items-center justify-content-between flex-wrap gap-16 px-20 py-12 border-bottom border-neutral-200">
            ...
            <div className="position-relative">
              <input type="text" className="form-control ps-40 py-9 border border-neutral-300 radius-8 text-secondary-light" placeholder="Search vendors..." value={search} onChange={(e) => { setSearch(e.target.value); setCurrentPage(1); }} />

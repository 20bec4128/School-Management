...
const ResultCard = () => {
  ...
  const filtered = useMemo(() => {
    ...
    return resultCardData.filter((r) => {
      const matchesSearch =
        !q ||
        [r.exam, r.letterGrade, r.position, String(r.gpa)]
          .join(' ')
          .toLowerCase()
          .includes(q)
      const matchesExam = filters.exam === 'Select' || r.exam === filters.exam
      const matchesRollNo = !filters.rollNo || r.sl === filters.rollNo
      return matchesSearch && matchesExam && matchesRollNo
    })
  }, [search, filters])
  ...
  const actualColCount = useMemo(() => {
    ...
    if (visibleColumns.exam) count += 1
  ...
  return (
    <div className="dashboard-main-body">
      <div className="breadcrumb d-flex flex-wrap align-items-center justify-content-between gap-3 mb-24">
        <div>
          <h1 className="fw-semibold mb-4 h6 text-primary-light">Result Card</h1>
          <div>
            <button
              type="button"
            ...
            <span className="text-secondary-light"> / Result Card</span>
          </div>
        </div>
          ...
          <div className="d-flex align-items-center justify-content-between flex-wrap gap-16 px-20 py-12 border-bottom border-neutral-200">
            ...
            <div className="position-relative">
              <input
                ...
                placeholder="Search by exam, grade..."
                value={search}
                onChange={(e) => {
            ...
            <table className="table bordered-table mb-0 data-table" style={{ minWidth: 1400 }}>
              <thead>
                ...
                <tr>
                  ...
                  {visibleColumns.exam ? <th scope="col" rowSpan="2">Exam</th> : null}
                  ...
                  {visibleColumns.gpa ? <th scope="col" rowSpan="2">GPA</th> : null}
                ...
                {paginated.length === 0 ? (
                  ...
                  paginated.map((row) => (
                    <tr key={row.sl}>
                      ...
                      {visibleColumns.exam ? <td className="fw-medium text-primary-light">{row.exam}</td> : null}
                      {visibleColumns.written ? (
                        <>
                      ...
                      {visibleColumns.gpa ? <td className="text-center fw-semibold">{row.gpa}</td> : null}
                      ...
                      {visibleColumns.lowest ? <td className="text-center">{row.lowest}</td> : null}

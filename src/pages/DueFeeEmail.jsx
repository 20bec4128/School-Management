...
const DueFeeEmail = () => {
  ...
  const filtered = useMemo(() => {
    ...
    return data.filter((row) => {
      ...
      return matchesSearch && matchesSchool && matchesReceiver && matchesClass;
    });
  }, [data, search, filters]);
  ...
  const handleExportCSV = () => {
    ...
    downloadTextFile("due-fee-emails.csv", [header, ...rows].join("\n"), "text/csv;charset=utf-8");
  };
  ...
  const handleExportXLS = async () => {
    ...
    XLSX.writeFile(workbook, "due-fee-emails.xlsx");
  };
  ...
  const handleExportPDF = async () => {
    ...
    doc.text("Due Fee Email Logs", 14, 14);
  ...
  return (
    <div className="dashboard-main-body">
      <div className="breadcrumb d-flex flex-wrap align-items-center justify-content-between gap-3 mb-24">
        <div>
          <h1 className="fw-semibold mb-4 h6 text-primary-light">Due Fee Email</h1>
          <span className="text-secondary-light">Dashboard / Due Fee Email</span>
        </div>
      </div>
            ...
            <div className="d-flex flex-wrap align-items-center gap-16">
              <div className="dropdown">
                ...
                <ul className="dropdown-menu p-12 border bg-base shadow">
                  <li><button type="button" className="dropdown-item px-16 py-8 rounded text-secondary-light bg-hover-neutral-200 d-flex align-items-center gap-10" onClick={handleExportCSV}><i className="ri-file-text-line"></i> CSV</button></li>
                  <li><button type="button" className="dropdown-item px-16 py-8 rounded text-secondary-light bg-hover-neutral-200 d-flex align-items-center gap-10" onClick={() => void handleExportXLS()}><i className="ri-file-excel-2-line"></i> Excel</button></li>
                  <li><button type="button" className="dropdown-item px-16 py-8 rounded text-secondary-light bg-hover-neutral-200 d-flex align-items-center gap-10" onClick={() => void handleExportPDF()}><i className="ri-file-3-line"></i> PDF</button></li>
                </ul>
              </div>
      ...
      <SlideSidebar isOpen={isFilterSidebarOpen} title="Filter Emails" onClose={() => setIsFilterSidebarOpen(false)}>

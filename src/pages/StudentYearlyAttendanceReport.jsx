...
const StudentYearlyAttendanceReport = () => {
  ...
  const renderPercentage = (value) => {
    ...
    if (val >= 90) colorClass = 'text-success-600'
    else if (val >= 75) colorClass = 'text-primary-600'
    else if (val >= 50) colorClass = 'text-warning-600'
  ...
  return (
    <div className="dashboard-main-body">
      <div className="breadcrumb d-flex flex-wrap align-items-center justify-content-between gap-3 mb-24">
        <div>
          <h1 className="fw-semibold mb-4 h6 text-primary-light">Student Yearly Attendance Report</h1>
          <span className="text-secondary-light">Dashboard / Yearly Attendance</span>
        </div>
      </div>
              ...
              <thead>
                <tr>
                  ...
                  {columnOptions.map((col) => visibleColumns[col.key] && (
                    <th scope="col" key={col.key} className={col.key === 'studentName' ? '' : 'text-center'}>
                      {col.label}
                    </th>
                  ))}
                </tr>
                ...
                {paginated.length === 0 ? (
                  ...
                  paginated.map((row, idx) => (
                    <tr key={idx}>
                      ...
                      {columnOptions.map((col) => visibleColumns[col.key] && (
                        <td key={col.key} className={col.key === 'studentName' ? 'fw-medium text-primary-light' : 'text-center'}>
...
export default StudentYearlyAttendanceReport
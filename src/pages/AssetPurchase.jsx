...
const AssetPurchase = ({ onNavigate }) => {
  /** * 2. State Management
   */
  ...
  const handleExportExcel = () => {
    ...
    XLSX.utils.book_append_sheet(workbook, worksheet, "AssetPurchases");
    XLSX.writeFile(workbook, "Asset_Purchase_Report.xlsx");
  };

  const handleExportPDF = () => {
    const doc = new jsPDF({ orientation: 'landscape' });
    doc.text("Asset Purchase Report", 14, 10);
    doc.autoTable({
    ...
    doc.save('Asset_Purchase_Report.pdf');
  };
  ...
  return (
    <div className="dashboard-main-body">
      <div className="breadcrumb d-flex flex-wrap align-items-center justify-content-between gap-3 mb-24">
        <div>
          <h1 className="fw-semibold mb-4 h6 text-primary-light">Asset Purchase</h1>
          <span className="text-secondary-light">Inventory / Purchase Management</span>
        </div>
        <button className="btn btn-primary-600 d-flex align-items-center gap-6" onClick={() => onNavigate?.('add-asset-purchase')}>

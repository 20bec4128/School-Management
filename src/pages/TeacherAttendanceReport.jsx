  ...
  return (
    <div className="dashboard-main-body">
      <div className="breadcrumb d-flex flex-wrap align-items-center justify-content-between gap-3 mb-24">
        <div>
          <h1 className="fw-semibold mb-4 h6 text-primary-light">Teacher Attendance Report</h1>
          <span className="text-secondary-light">Dashboard / Teacher Attendance</span>
        </div>
      </div>
      ...
      <div className="card h-100">
        <div className="card-body p-0 dataTable-wrapper">
          ...
          <div className="p-0 table-responsive">
            <table className="table bordered-table mb-0 data-table teacher-attendance-table" style={{ minWidth: 1500 }}>
              <thead>
                <tr>
                  ...
                  <th scope="col" style={{ position: 'sticky', left: '70px', background: '#fff', zIndex: 2, minWidth: '200px' }}>Teacher Name</th>
                  {dateColumns.map((col) => (
      ...
      <style dangerouslySetInnerHTML={{ __html: `
        ...
        .teacher-attendance-table thead th {

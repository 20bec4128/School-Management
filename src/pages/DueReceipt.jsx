  ...
  return (
    <div className="dashboard-main-body">
      <div className="breadcrumb d-flex flex-wrap align-items-center justify-content-between gap-3 mb-24">
        <div>
          <h1 className="fw-semibold mb-4 h6 text-primary-light">Due Receipt</h1>
          <span className="text-secondary-light">Dashboard / Due Receipt</span>
        </div>
      </div>
                ...
                {paginated.length === 0 ? (
                  ...
                  paginated.map((row, idx) => (
                    <tr key={idx}>
                      ...
                      {visibleColumns.school && <td className="fw-medium text-primary-light">{row.school}</td>}
                      {visibleColumns.invoiceNumber && <td className="fw-medium">{row.invoiceNumber}</td>}
                      ...
                      {visibleColumns.paidAmount && <td className="text-success-600">{row.paidAmount}</td>}
                      {visibleColumns.dueAmount && <td className="text-danger-600 fw-bold">{row.dueAmount}</td>}
                      <td>
                        <div className="d-flex align-items-center gap-10">
                          <button type="button" className="bg-primary-focus bg-hover-primary-200 text-primary-600 fw-medium w-32-px h-32-px d-flex align-items-center justify-content-center rounded-circle" title="Collect Payment">
                            <i className="ri-money-dollar-box-line"></i>
                          </button>
                          <button type="button" className="bg-info-focus bg-hover-info-200 text-info-600 fw-medium w-32-px h-32-px d-flex align-items-center justify-content-center rounded-circle" title="Print Receipt">
      ...
      <SlideSidebar isOpen={isFilterSidebarOpen} title="Filter Due Receipts" onClose={() => setIsFilterSidebarOpen(false)}>
        <form

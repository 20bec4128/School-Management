...
const ApprovedApplication = () => {
  ...
  const schoolOptions = useMemo(
    () => Array.from(new Set(approvedApplicationData.map((item) => item.school))),
    [],
  )
  const academicYearOptions = useMemo(
    () => Array.from(new Set(approvedApplicationData.map((item) => item.academicYear))),
    [],
  )
  const applicantTypeOptions = useMemo(
    () => Array.from(new Set(approvedApplicationData.map((item) => item.applicantType))),
    [],
  )
  const leaveTypeOptions = useMemo(
    () => Array.from(new Set(approvedApplicationData.map((item) => item.leaveType))),
    [],
  )
  ...
  const filtered = useMemo(() => {
    ...
    return approvedApplicationData.filter((row) => {
      const matchesSearch =
        !q ||
  ...
  return (
    <div className="dashboard-main-body">
      <div className="breadcrumb d-flex flex-wrap align-items-center justify-content-between gap-3 mb-24">
        <div>
          <h1 className="fw-semibold mb-4 h6 text-primary-light">Approved Application</h1>
          <div>
            <button
              type="button"
            ...
            <span className="text-secondary-light"> / Approved Application</span>
          </div>
        </div>
      </div>
      ...
      <SlideSidebar
        ...
        title="Filter Approved Application"
